...
import { extensionRoutes } from './modules/api/routes/extension.js';
import { dmPreviewsRoutes } from './modules/api/routes/dmPreviews.js';
...
await app.register(dmPreviewsRoutes);
